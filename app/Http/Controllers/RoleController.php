            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        if(auth()->user()->can('update_roles')) {
                            $btn .= '<a title="'.transWord('edit').'" href="'.route('roles.edit', $row->id).'" class="btn btn-info me-2">
                                        <i class="fas fa-edit"></i>
                                    </a>';
                        }
                        if(auth()->user()->can('delete_roles')) {
                            $btn .= '<a title="'.transWord('delete').'" id="delete" href="'.route('roles.delete', $row->id).'" class="btn btn-danger">
