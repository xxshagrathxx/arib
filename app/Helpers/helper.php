...
function menuNoChildren($path, $multiLang = false, $defaultLang = 'en') {
    $class = '';

    if($multiLang)
        Request::is('en/'. $path) || Request::is('ar/'. $path) ? $class = 'nav-link' : $class = 'nav-link collapsed';
    else
        Request::is($defaultLang . '/'. $path) ? $class = 'nav-link' : $class = 'nav-link collapsed';

    return $class;
}

function parentMenuCollapse($path, $multiLang = false, $defaultLang = 'en') {
    $class = '';
...
function parentMenuActive($path, $multiLang = false, $defaultLang = 'en') {
    $class = '';

    if($multiLang)
        Request::is('en/'. $path . '/*') || Request::is('ar/'. $path . '/*') ? $class = 'nav-content collapse show' : $class = 'nav-content collapse';
    else
        Request::is($defaultLang . '/'. $path . '/*') ? $class = 'nav-content collapse show' : $class = 'nav-content collapse';

    return $class;
}

function childMenuActive($path, $multiLang = false, $defaultLang = 'en') {
    $class = '';

    if($multiLang)
        Request::is('en/'. $path . '/*') || Request::is('ar/'. $path . '/*') ? $class = 'active' : $class = '';
    else
        Request::is($defaultLang . '/'. $path . '/*') ? $class = 'active' : $class = '';
